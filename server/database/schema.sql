...
VALUES 
  ("Integration - Partie 1", "27", "/assets/videos/Quest-Welcomeonboard(part1).mp4", "/assets/images/videoPreviewImages/welcomeOnBoard.png","Entraîne toi à reproduire une maquette en HTML", 1, false, "2025-11-01", true, true),
  ("Integration - Partie 2", "17", "/assets/videos/Quest-Welcomeonboard(part2).mp4", "/assets/images/videoPreviewImages/WelcomeOnBoard2.png","Ajoute le CSS pour reproduire une maquette", 2, true, "2025-11-01", true, false),
  ...
  ("Basics HTML & CSS - Partie 2", "12", "/assets/videos/Workshop1-HTML&CSS(Part2).mp4", "/assets/images/videoPreviewImages/workShop2.png", "Donne du style à ton site web avec les propriétés CSS", 2, true, "2025-11-01", true, true),
